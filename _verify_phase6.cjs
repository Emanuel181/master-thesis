// CJS verification of agent-tester-pentest internals
const path = require('node:path');
const Module = require('node:module');
const crypto = require('node:crypto');

// Stub @aws-sdk/* modules BEFORE the lambda is loaded
const FAKE = {
...
Module._load = function (request, parent, isMain) {
    if (typeof request === 'string' && request.startsWith('@aws-sdk/')) return FAKE;
...
const impl = require(path.resolve('infrastructure/lambda/agent-tester-pentest/index.js'));
...
// 3) HMAC matches lib/hmac.js
const secret = 'sec', ts = '1700000000', rid = 'rid-1', body = JSON.stringify({ a: 1 });
