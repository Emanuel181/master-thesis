 ...
 */
export async function FeaturesSection({ techLogos }) {
        ...
        <div className="text-center mb-10 sm:mb-12 md:mb-16 lg:mb-20">
          <div className="text-center px-2">
            ...
            <div className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-foreground leading-tight">
              ...
              >
                <span className="bg-gradient-to-br from-primary to-accent bg-clip-text text-transparent">{t('headingHighlight')}</span>
              </PointerHighlight>
            </div>
          </div>
