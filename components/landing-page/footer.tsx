                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Features</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Integrations</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Enterprise</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Changelog</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Docs</a></Button></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">About Us</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Careers</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Blog</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Contact</a></Button></li>
                            <li><Button variant="link" asChild className="p-0 h-auto text-muted-foreground hover:text-foreground"
                                        size={undefined}><a href="#">Partners</a></Button></li>
                        </ul>
                    </div>
