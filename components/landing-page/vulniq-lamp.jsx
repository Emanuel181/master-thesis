    ...
    return (
        <LampContainer>
            <motion.h2
                ...
                className="mt-4 xs:mt-6 sm:mt-12 bg-gradient-to-br from-[var(--brand-light)] to-[var(--brand-accent)] py-4 xs:py-6 sm:py-8 bg-clip-text text-center text-5xl xs:text-6xl sm:text-8xl md:text-9xl lg:text-[12rem] font-bold tracking-tight text-transparent px-4"
            >
                VulnIQ
            </motion.h2>
            ...
            <motion.p
                ...
                className="mt-4 xs:mt-6 sm:mt-8 text-slate-300 text-center text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl max-w-xs xs:max-w-sm sm:max-w-xl md:max-w-3xl lg:max-w-4xl px-4"
            >
            ...
            >
                ...
                <Button asChild variant="outline" size="lg" className="rounded-lg sm:rounded-xl w-full sm:w-auto text-sm sm:text-base md:text-lg lg:text-2xl px-5 sm:px-6 md:px-8 lg:px-10 py-2.5 sm:py-3 md:py-5 lg:py-7 h-auto bg-transparent border-slate-500 text-slate-200 hover:bg-slate-800 hover:text-slate-100">
                    <a href="#features">
                        Learn more
                    </a>
                </Button>
