        ...
        >
            <FieldGroup>
                ...
                <motion.div variants={itemVariants} className="flex flex-col items-center gap-2 text-center mb-6">
                    ...
                    <p className="text-muted-foreground text-lg text-balance max-w-[80%]">
                ...
                <div className="flex flex-col gap-3">
                    <Field>
                        ...
                        {/* Google */}
                        <motion.div variants={itemVariants} className="mt-3" whileTap={{ scale: 0.98 }}>
                            <Button
                                variant="outline"
                                type="button"
                                disabled={isLoading !== null}
