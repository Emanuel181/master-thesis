...
export function ThemeToggleButton({
  ...
  return (
    <button
      ...
      className={`relative inline-flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-background hover:bg-muted hover:border-primary/30 transition-all duration-150 disabled:opacity-50 ${className}`}
