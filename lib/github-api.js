...
export async function fetchRepoTree(owner, repo, provider) {
    if (!provider) throw new Error('provider is required (github or gitlab)');
...
export async function fetchFileContent(owner, repo, path, provider) {
    if (!provider) throw new Error('provider is required (github or gitlab)');
