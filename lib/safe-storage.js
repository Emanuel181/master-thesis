...
// SECURITY: Keys ordered by priority (last = least important, cleared first)
// Includes both production and demo mode keys for proper cleanup
const CLEARABLE_KEYS = [
    ...
    // Demo keys
    'vulniq_demo_editor_tabs',
    'vulniq_demo_code_state',
    'vulniq_demo_editor_language',
    'vulniq_demo_project_state',
];
