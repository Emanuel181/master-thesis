...
export async function startSecurityAnalysis({ userId, groupIds, code, codeType, selectedDocuments: passedDocuments, currentRepo }) {
  try {
    ...
    const response = await fetch('/api/workflow/start', {
      ...
      body: JSON.stringify({
        ...
        metadata: {
          ...
          currentRepo: currentRepo || null, // Repo info for automated fixer PR creation
        },
      }),
    });
